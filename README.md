# Fully customizable, easily configurable bloatless desktop shell for Niri and Hyprland written in QML/Quickshell
## What is this?
...
If you have swww-daemon or brightnessctl and want to use them like in the video (brightness slider and wallpaper changer), use nixos-config-retinotopic branch (not main). It is used for my NixOS configuration, wallpapers and other dots also available [there](https://github.com/retinotopic/nixos-config).
...
These 3 dependencies are optional because you can activate and deactivate them in the Bar.qml file
1. Cava
